...
export default function Ajout({ navigation, setUser }: { navigation?: any, setUser:React.Dispatch<React.SetStateAction<string>> }) {
  ...
  return (
    <View style={{justifyContent: 'center', ...styles.container}}>
      <MInput placeholder="Nom d'utilisateur" onChangeText={setName}></MInput>
        <Button title="Billy"  onPress={SendUser}></Button>
    </View>
  );
}
